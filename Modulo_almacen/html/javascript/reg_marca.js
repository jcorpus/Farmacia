...
function reg_marca(){
  ...
  var txtmmarca = $("#txtmmarca").val();
  var txtusuario = $("#usuarioa_id").val();
  var txtestadom = $("#txtestado_marca").val();
  ...
  /// metodos de ajax aqui http://www.w3schools.com/jquery/ajax_ajaxsetup.asp
	$.ajax({
		url:'controller/controller_marca.php',
		type: 'POST',
    data: {
      txtmmarca:txtmmarca,
      txtestadom:txtestadom,
...
function mod_marca(){
  ...
  //var emaill = document.getElementById("get_pass_user").value;
  //var formusuario = new FormData($("#formulario_categoria")[0]);
  var txtmmarca2 = $("#txtmmarca2").val();
  var id_marca = $("#id_marca2").val();
  var txtusuario = $("#usuarioa_id").val();
  //var txtestadom2 = $("#estado_marca2").val();
