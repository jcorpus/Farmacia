                ...
                <div class="box-header with-border">
                  ...
                  <div class="box-body">
                    <div id="listar" class="icon-loading">
                      <i id="loading_marca" style="margin:auto;display:block; margin-top:60px;"></i>
                      <div id="nodatos"></div>
                    </div>
                      <p id="paginador_marca" class="mi_paginador"></p>
                  </div>
              </div>
          </div>
        </div>
...
<script src="html/javascript/list_marca.js"></script>
<script src="html/javascript/reg_marca.js"></script>
